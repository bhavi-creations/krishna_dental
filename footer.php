                     ...
                     <div class="widget footer-widget">
                         <div class="vs-widget-about-seven">
                             ...
                             <ul class="footer-link-seven">
                                 <li><a href="https://www.facebook.com/krishnadentacure/" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                 <li><a href="https://www.instagram.com/krishnadentacure/" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                 <li><a href="https://www.google.com/maps/place/Krishna+Denta+Cure/@17.0088626,81.7762509,17z/data=!3m1!4b1!4m6!3m5!1s0x3a37a40a542c11a9:0x160849045a8511d6!8m2!3d17.0088626!4d81.7762509!16s%2Fg%2F11c155pc67?authuser=0&entry=ttu&g_ep=EgoyMDI1MDIwMy4wIKXMDSoASAFQAw%3D%3D" target="_blank"><i class="fab fa-google"></i></a></li>
                             </ul>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="col-7 col-md-6 col-lg-3  wow fadeInUp" data-wow-delay="600ms">
                     <div class="widget v1 footer-widget widget_nav_menu-seven">
                         ...
                         <div class="menu-all-pages-container">
                             <ul class="menu-seven">
                                 <li><a href="root-canal-treatment-in-rajahmundry.php"> Root Canal</a></li>
                     ...
                     <div class="widget v1 footer-widget widget_nav_menu-seven">
                         ...
                         <div class="menu-all-pages-container">
                             <ul class="menu-seven">
                                 ...
                                 <li><a href="dental-implants-treatment-in-rajahmundry.php">Dental Implants </a></li>
                                 <li><a href="dental-dentures-treatment-in-rajahmundry.php">Dentures </a></li>
                                 <li><a href="fluoride-application-and-dental-sealant-treatment-in-rajahmundry.php">
                                         Fluoride Application & Dental Sealant </a></li>
                                 <li><a href="full-mouth-rehabilitation-treatment-in-rajahmundry.php">
...
========================================================== -->
<footer class="footer">
  <div class="footer_leaf_left"></div>
  <div class="footer_leaf_right"></div>

  <div class="footer_main">
    <div class="container footer_container">
      <div class="row g-4">

        <div class="col-xl-3 col-lg-3 col-md-6 col-12 footer_brand_col">
          <div class="footer_logo_wrap">
            <img src="assets/img/logo/krishna_new_logo-removebg-preview.png" alt="Krishna Denta Cure logo">
          </div>

          <div class="footer_brand_tag">
            Healthy Smiles
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-4 col-lg-4 col-md-12 col-12 footer_column_block footer_our_services">
            ...
            <ul class="footer_links">
                ...
                <li><a href="gum-care-treatment-in-rajahmundry.php"><i class="footer_arrow"></i>Gum Treatments</a></li>
                <li><a href="teeth-cleaning-treatment-in-rajahmundry.php"><i class="footer_arrow"></i>Teeth Cleaning</a></li>
  ...
  <div class="footer_bottom">
    <div class="footer_bottom_inner">
      <div class="footer_copy">
        <span class="footer_copy_icon">C</span>
        <span>2024 Krishna Denta Cure. All Rights Reserved.</span>
      </div>
...
<!-- ==========================================================
     NEW SECTIONS - SLIDER SCRIPTS
     Centralized in footer.php; runs only when matching home sections exist.
========================================================== -->
<script>
(function () {
  ...
  const originalSlides = Array.from(track.children).filter(function (slide) {
    return !slide.hasAttribute('data-index-third-clone');
  });
  ...
  function removeClones() {
    track.querySelectorAll('[data-index-third-clone="true"]').forEach(function (clone) {
      clone.remove();
    });
  }
  ...
  function slideStepWidth() {
    const firstSlide = track.querySelector('.index_third_slide');
    return firstSlide ? firstSlide.getBoundingClientRect().width : 0;
  }

  function setPosition(animate) {
    const step = slideStepWidth();
  ...
  window.addEventListener('resize', function () {
    ...
    resizeTimer = setTimeout(rebuildSlider, 180);
  });
...
<script>
(function () {
  const section = document.querySelector('.index_fifth_section');
  if (!section) return;
  ...
  const originalSlides = Array.from(track.children).filter(function (slide) {
    return !slide.hasAttribute('data-index-fifth-clone');
  });
  ...
  function removeClones() {
    track.querySelectorAll('[data-index-fifth-clone="true"]').forEach(function (clone) {
      clone.remove();
    });
  }
  ...
  function slideStepWidth() {
    const slides = track.querySelectorAll('.index_fifth_card');

    if (slides.length > 1) {
      return slides[1].offsetLeft - slides[0].offsetLeft;
    }

    return slides.length ? slides[0].getBoundingClientRect().width : 0;
  }

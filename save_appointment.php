...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($h->num_rows > 0) {
        ...
        // ఫ్రంట్-ఎండ్ స్లాట్స్ తో పక్కాగా మ్యాచ్ అయ్యేలా సింగిల్ డిజిట్ ఫార్మాట్ లో మార్చాను
        $morningSlots = [
            "9:00 AM - 10:00 AM",
            "10:00 AM - 11:00 AM",
            "11:00 AM - 12:00 PM",
        ...
        // ఎండ్ టైమ్స్ ని 'get_slots.php' లాగే '08:00 PM' అండ్ '09:00 PM' కి అప్‌డేట్ చేశాను
        $afternoonSlots = [
            "01:00 PM - 02:00 PM",
            "02:00 PM - 03:00 PM",
            "03:00 PM - 04:00 PM",

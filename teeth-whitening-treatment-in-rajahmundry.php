...
<img src="./assets/img/bg/teeth_whitening_1.png" alt="about" class="img-fluid">
...
<section class="vs-service-wrapper service_premium_section space-top space-md-bottom">
    ...
    <div class="container service_premium_container">
        ...
        <div class="service_premium_heading text-center">
            <h1 class="mb-0">Teeth Whitening <span>in Rajahmundry</span> <br> Brighten Your Smile Instantly</h1>

            <p class="fs-md text-title mb-0 service_premium_intro">At Krishna Dental Cure, we offer professional teeth whitening in Rajahmundry to remove stains and discoloration, giving you a whiter, more confident smile.</p>
        </div>
            ...
            <div class="col-12 col-md-8 service_text_padding">
                <div class="service_premium_step_content">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Activation and Final Polishing</h3>

                ...
                <div class="row justify-content-center justify-content-lg-between">
                    ...
                    <div class="col-md-6 col-lg-auto  mb-30">
                        <div class="d-xl-flex text-center text-xl-start skill-box">
                            ...
                            <div class="media-body">
                                <h2 class="mt-n2 mb-0 text-theme">7+</h2>
                    ...
                    <div class="col-md-6 col-lg-auto  mb-30">
                        <div class="d-xl-flex text-center text-xl-start skill-box">
                            ...
                            <div class="media-body">
                                <h2 class="mt-n2 mb-0 text-theme">40k+</h2>
                        ...
                        <div class="row pt-3">
                            <div class="col-sm-6 col-lg-5 col-xl-6">
                                <div class="d-flex mb-25">
                                    <span class="text-theme mr-20"><i class="fas fa-shield-alt fa-2x lh-1"></i>
                                    </span>
                                    <div class="media-body">
                            ...
                            <div class="col-sm-6 col-lg-5 col-xl-6">
                                <div class="d-flex mb-25">
                                    <span class="text-theme mr-20"><i class="fas fa-stethoscope fa-2x lh-1"></i>
                                    </span>
                                    <div class="media-body">
                            ...
                            <div class="col-sm-6 col-lg-5 col-xl-6">
                                <div class="d-flex mb-25">
                                    <span class="text-theme mr-20"><i class="fas fa-headset fa-2x lh-1"></i></span>
                                    <div class="media-body">
                            ...
                            <div class="col-sm-6 col-lg-5 col-xl-6">
                                <div class="d-flex mb-25">
                                    <span class="text-theme mr-20"><i class="fas fa-tooth fa-2x lh-1"></i></span>
                                    <div class="media-body">

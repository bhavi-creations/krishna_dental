...
<img src="./assets/img/bg/smile_makeover_1.png" alt="about" class="img-fluid">
...
<section class="vs-service-wrapper service_premium_section space-top space-md-bottom">
    ...
    <div class="container service_premium_container">
        ...
        <div class="service_premium_heading text-center">
            <h1 class="mb-0">Smile Makeover <span>in Rajahmundry</span> <br> Achieve a Perfect, Radiant Smile</h1>

            <p class="fs-md text-title mb-0 service_premium_intro">At Krishna Dental Cure, we offer customized smile makeovers in Rajahmundry to enhance your smile using advanced cosmetic and restorative treatments.</p>
        </div>
            ...
            <div class="col-12 col-md-8 service_text_padding">
                <div class="service_premium_step_content">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Smile Assessment and Planning</h3>
            ...
            <div class="col-12 col-md-8 service_text_padding order-0 order-md-1">
                <div class="service_premium_step_content service_premium_step_content_reverse">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Cosmetic and Restorative Treatments</h3>
            ...
            <div class="col-12 col-md-8 service_text_padding">
                <div class="service_premium_step_content">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Final Adjustments and Smile Reveal</h3>

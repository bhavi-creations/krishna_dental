            ...
            <div class="col-md-6 col-xl-4">
                <div class="service-thumb">
                    ...
                    <div class="sr-body">
                        ...
                        <div class="sr-content">
                            <p class="sr-text">Invisible aligners straighten teeth discreetly using clear, removable trays, enhancing alignment, comfort, and confidence. </p>
                            <a href="invisaliners.php" class="link-btn">Read More<i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>

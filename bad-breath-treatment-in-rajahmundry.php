...
<section class="vs-service-wrapper service_premium_section space-top space-md-bottom">
    ...
    <div class="container service_premium_container">
        ...
        <div class="service_premium_heading text-center">
            <h1 class="mb-0">Bad Breath Treatment <span>in Rajahmundry</span> <br> Say Goodbye to Halitosis</h1>

            <p class="fs-md text-title mb-0 service_premium_intro">At Krishna Dental Cure, we provide effective bad breath treatment in Rajahmundry to eliminate halitosis and restore fresh breath. Our advanced solutions target the root cause for long-term oral health.</p>
        </div>
            ...
            <div class="col-12 col-md-8 service_text_padding">
                <div class="service_premium_step_content">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Diagnosis and Oral Cleaning</h3>
            ...
            <div class="col-12 col-md-8 service_text_padding order-0 order-md-1">
                <div class="service_premium_step_content service_premium_step_content_reverse">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Treating Underlying Causes</h3>
            ...
            <div class="col-12 col-md-8 service_text_padding">
                <div class="service_premium_step_content">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Personalized Oral Hygiene Plan</h3>

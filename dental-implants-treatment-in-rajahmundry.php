...
<img src="./assets/img/bg/dental_implants_1.png" alt="about" class="img-fluid">


<!-- <div class="breadcumb-wrapper ">
    <div class="parallax" data-parallax-image="assets/img/about/krishnadentacure_slider_Dental_Implants.png"></div>

    <div class="container z-index-common">
        <div class="breadcumb-content">
            <h1 class="breadcumb-title">Dental Implants</h1>
...
<section class="vs-service-wrapper service_premium_section space-top space-md-bottom">
    ...
    <div class="container service_premium_container">
        ...
        <div class="service_premium_heading text-center">
            <h1 class="mb-0">Dental Implants <span>in Rajahmundry</span> <br> Permanent Solution for Missing Teeth</h1>

            <p class="fs-md text-title mb-0 service_premium_intro">At Krishna Dental Cure, we provide high-quality dental implants in Rajahmundry to restore missing teeth with a natural look and long-lasting durability.</p>
        </div>
        ...
        <div class="swiper-container team-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="team-card">
                        <div class="team-head">
                            <img src="assets/img/service_sliders/krishnadentacure_ Dental_Implants_1.png" alt="Team Area" class="w-100">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="team-card">
                        <div class="team-head">
                            <img src="assets/img/service_sliders/krishnadentacure_ Dental_Implants_2.png" alt="Team Area" class="w-100">
                ...
                <div class="swiper-slide">
                    <div class="team-card">
                        <div class="team-head">
                            <img src="assets/img/service_sliders/krishnadentacure_ Dental_Implants_3.png" alt="Team Area" class="w-100">
                ...
                <div class="swiper-slide">
                    <div class="team-card">
                        <div class="team-head">
                            <img src="assets/img/service_sliders/krishnadentacure_ Dental_Implants_4.png" alt="Team Area" class="w-100">

...
<img src="./assets/img/bg/fluoride_application_dental_sealant_1.png" alt="about" class="img-fluid">
...
<section class="vs-service-wrapper service_premium_section space-top space-md-bottom">
    ...
    <div class="container service_premium_container">
        ...
        <div class="service_premium_heading text-center">
            <h1 class="mb-0">Fluoride Application & Dental Sealant <span>in Rajahmundry</span> – Protect Your Teeth</h1>

            <p class="fs-md text-title mb-0 service_premium_intro">At Krishna Dental Cure, we provide fluoride applications and dental sealants in Rajahmundry to strengthen teeth and prevent cavities, especially in children.</p>
        </div>
            ...
            <div class="col-12 col-md-8 service_text_padding">
                <div class="service_premium_step_content">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Teeth Cleaning and Preparation</h3>
            ...
            <div class="col-12 col-md-8 service_text_padding order-0 order-md-1">
                <div class="service_premium_step_content service_premium_step_content_reverse">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Fluoride and Sealant Application</h3>

...
<img src="./assets/img/bg/dental-veneers_1.png" alt="about" class="img-fluid">
...
<section class="vs-service-wrapper service_premium_section space-top space-md-bottom">
    ...
    <div class="container service_premium_container">
        ...
        <div class="service_premium_heading text-center">
            <h1 class="mb-0">Dental Veneers <span>in Rajahmundry</span> – Transform Your Smile with Precision</h1>

            <p class="fs-md text-title mb-0 service_premium_intro">At Krishna Dental Cure, we offer high-quality dental veneers in Rajahmundry to enhance your smile by correcting discoloration, chips, and minor misalignment.</p>
        </div>
        ...
        <div class="row serice_space_div service_premium_step service_premium_step_1 align-items-center">
            <div class="col-12 col-md-8 service_text_padding">
                <div class="service_premium_step_content">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Consultation and Tooth Preparation</h3>
            ...
            <div class="col-12 col-md-4 service_text_padding_img">
                <div class="service_premium_image_card">
                    <img src="assets/img/services_steps/krishnadentacure_services_veneers_1.png" alt="Service Image" class=" my-2 img-fluid service_border_radius_images">
                </div>
            </div>
        </div>
        ...
        <div class="row serice_space_div service_premium_step service_premium_step_2 align-items-center">
            <div class="col-12 col-md-4 service_text_padding_img order-1 order-md-0">
                <div class="service_premium_image_card">
                    <img src="assets/img/services_steps/krishnadentacure_services_veneers_2.png" alt="Service Image" class=" my-2 img-fluid service_border_radius_images">
                </div>
            </div>
            ...
            <div class="col-12 col-md-8 service_text_padding order-0 order-md-1">
                <div class="service_premium_step_content service_premium_step_content_reverse">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Custom Veneer Fabrication</h3>
        ...
        <div class="row serice_space_div service_premium_step service_premium_step_3 align-items-center">
            <div class="col-12 col-md-8 service_text_padding">
                <div class="service_premium_step_content">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Bonding and Final Adjustments</h3>
            ...
            <div class="col-12 col-md-4 service_text_padding_img">
                <div class="service_premium_image_card">
                    <img src="assets/img/services_steps/krishnadentacure_services_veneers_3.png" alt="Service Image" class=" my-2 img-fluid service_border_radius_images">
                </div>
            </div>
        </div>
        ...
        <div class="swiper-container team-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="team-card">
                        <div class="team-head">
                            <img src="assets/img/service_sliders/krishnadentacure_Dental_Veneers_1.png" alt="Team Area" class="w-100">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="team-card">
                        <div class="team-head">
                            <img src="assets/img/service_sliders/krishnadentacure_Dental_Veneers_2.png" alt="Team Area" class="w-100">
                ...
                <div class="swiper-slide">
                    <div class="team-card">
                        <div class="team-head">
                            <img src="assets/img/service_sliders/krishnadentacure_Dental_Veneers_3.png" alt="Team Area" class="w-100">
                ...
                <div class="swiper-slide">
                    <div class="team-card">
                        <div class="team-head">
                            <img src="assets/img/service_sliders/krishnadentacure_Dental_Veneers_4.png" alt="Team Area" class="w-100">

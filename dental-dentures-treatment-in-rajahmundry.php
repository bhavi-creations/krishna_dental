...
<img src="./assets/img/bg/dentures_1.png" alt="about" class="img-fluid">
...
<section class="vs-service-wrapper service_premium_section space-top space-md-bottom">
    ...
    <div class="container service_premium_container">
        ...
        <div class="service_premium_heading text-center">
            <h1 class="mb-0">Dentures <span>in Rajahmundry</span> <br> Restore Your Smile with Comfort</h1>

            <p class="fs-md text-title mb-0 service_premium_intro">At Krishna Dental Cure, we provide high-quality dentures in Rajahmundry to replace missing teeth, ensuring a natural look and improved oral function.</p>
        </div>
            ...
            <div class="col-12 col-md-8 service_text_padding">
                <div class="service_premium_step_content">
                    ...
                    <div class="service_premium_step_copy">
                        ...
                        <h3>Oral Examination and Impressions</h3>
